  ...
  function getMatch() {
    fetch('https://frontend-take-home-service.fetch.com/dogs/match', {
      ...
      .then(data => {
        ...
        // so we need to get the dog entire object using the dog id and save that to match (instead of the id)
      ...
      }
      {
        ...
        <div>
          <div>
            ...
            <input id="zipCodes" type="text" name="zipCodes" value={zipCodes} onChange={e => setZipCodes(e.target.value)} />

            <label htmlFor="ageMin">Minimum Age:</label>
            <input id="ageMin" type="number" name="ageMin" value={ageMin} onChange={e => setAgeMin(e.target.value)} />

            <label htmlFor="ageMax">Maximum Age:</label>
            <input id="ageMax" type="number" name="ageMax" value={ageMax} onChange={e => setAgeMax(e.target.value)} />

            <label htmlFor="size">Size:</label>
            <input id="size" type="number" name="size" value={size} onChange={e => setSize(parseInt(e.target.value))} />

            <label htmlFor="sortField">Sort Field:</label>
            <input id="softField" type="text" name="sortField" value={sortField} onChange={e => setSortField(e.target.value)} />

            <label htmlFor="sort">Sort:</label>
            <input id="sort" type="text" name="sort" value={sort} onChange={e => setSort(e.target.value)} />
          ...
          <div className="cardsContainer">
            {dogs.map(dog => (
              <div className="card" key={dog.id}>
                ...
                <button className="cardBtn" onClick={() => handleSelectDog(dog)}>Select Dog</button>
              </div>
            ))}
          </div>
